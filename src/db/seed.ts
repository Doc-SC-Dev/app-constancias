...
export async function seedDatabase() {
    ...
    try {
        ...
        await createRolesAndPermission();
        await createUser(ROLE_NAMES.ADMIN, { email: "admin@admin.cl", password: "123456789" })
...
export async function createUser(role: string = ROLE_NAMES.ADMIN, userData: typeof loginSchema.infer) {
    // buscar si el correo existe primero
    try {
...
async function createRolesAndPermission() {
